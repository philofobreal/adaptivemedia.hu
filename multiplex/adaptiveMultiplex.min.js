...
(function(){var n=jQuery.noConflict(!0),t=adaptiveMediaMultiplexConfig,i=null,o=null,r=!1,u=!1,f=!1,e=!1;videojs("adaptiveMultiplexVideo",{html5:{nativeControlsForTouch:!1,enableTouchActivity:!0}},function(){function a(){s.load(),s.poster(t.video.url.previewImage),s.volume(60),c.after(n("<div />",{id:"_vjs-poster_","class":"vjs-poster",on:{click:function(){return window.open(t.clickURL,t.clickTarget),!1}}})),l(),n("#multiplex_container").css({height:"auto"}),n("#adaptiveMultiplexVideo").css({visibility:"visible"})}function l(){clearInterval(o),i=setInterval(function(){h.css({left:(h.parent().outerWidth()-h.outerWidth())/2+"px",top:(h.parent().outerHeight()-h.outerHeight())/2+"px",visibility:"visible"})},100)}var s=this,h=n(".vjs-big-play-button"),c=n(".vjs-poster"),v=c[0];a(),n(window).resize(function(){l()});s.on("click",function(r){var u=r.target.className,f=n(r.target),o=f.closest("button").attr("title")=="Play Video";return clearInterval(i),o&&(s.play(),e||(e=!0,n.get(t.video.events.manual_expand,function(){}))),u=="vjs-poster"||u.indexOf("adaptiveMultiplexVideo-dimensions")>-1?(window.open(t.clickURL,t.clickTarget),i=setInterval(function(){s.pause(),s.hasStarted(!1),s.bigPlayButton.show(),s.currentTime(0),clearInterval(i)}.bind(s),200),!1):void 0});s.on("ended",function(){s.hasStarted(!1),s.bigPlayButton.show(),s.currentTime(0),n("#_vjs-poster_").show(),f||(f=!0,n.get(t.video.events.end,function(){}))});s.on("timeupdate",function(){var i=arguments[0].target.player.cache_.duration,f=i/100*t.video.events.proc01.percentage,e=i/100*t.video.events.proc02.percentage;!r&&i!=0&&arguments[0].target.player.cache_.currentTime>=f&&(r=!0,n.get(t.video.events.proc01.url,function(){})),!u&&i!=0&&arguments[0].target.player.cache_.currentTime>=e&&(u=!0,n.get(t.video.events.proc02.url,function(){}))});s.on("playing",function(){n("#_vjs-poster_").hide()})})})();      
